...
- [4. 💻 demos.2 - “列表渲染”中的“列表”其实就是“数组”，且列表中的 react 元素必须加上 key](#4--demos2---列表渲染中的列表其实就是数组且列表中的-react-元素必须加上-key)
- [5. 🔍 查看关于文档对于列表渲染时为什么要给元素加 key 的说明](#5--查看关于文档对于列表渲染时为什么要给元素加-key-的说明)
- [6. 🤔 为什么需要 `key`？](#6--为什么需要-key)
<!-- endregion:toc -->
...
## 4. 💻 demos.2 - “列表渲染”中的“列表”其实就是“数组”，且列表中的 react 元素必须加上 key
...
## 5. 🔍 查看关于文档对于列表渲染时为什么要给元素加 key 的说明
