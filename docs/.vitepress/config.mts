...
export default defineConfig({
  ...
  base: '/notes/',
  title: 'TNotes',
  description: 'TNotes - 记录学习与开发过程中的笔记分享，涵盖前端开发、技术文档和个人心得等内容。',
  appearance: 'dark',
  srcDir: './src',
  lastUpdated: true,
  ...
  head: [
    ['meta', { name: 'keywords', content: 'TNotes, Tdahuyou, Tdahuyou 的笔记' }],
    ...
    ['meta', { property: 'og:description', content: '记录学习与开发过程中的笔记分享，涵盖前端开发、技术文档和个人心得。' }],
    ...
    [
      'script',
      { async: '', src: 'https://www.googletagmanager.com/gtag/js?id=G-PKWV2KVJR7' }
    ],
    [
      'script',
      {},
    ...
    sidebar: [
      { text: '👀 README', link: '/README' },
      {
        ...
        items: [
          ...
          { text: '💭 TNotes Discussions 的技术实现', link: '/tnotes/message-board' },
          { text: '📂 大型资源的处理机制', link: '/tnotes/handle-assets' },
          { text: '📺 视频资源的处理流程', link: '/tnotes/handle-video' },
      ...
      },
      {
        ...
        items: [
          ...
          // 按照字母排序：
          // { ...sidebar__c_cpp,                              text: 'c-cpp'               },
          // { ...sidebar__canvas,                             text: 'canvas'              },
          // { ...sidebar__chrome,                             text: 'chrome'              },
          // { ...sidebar__electron,                           text: 'electron'            },
          // { ...sidebar__en_notes,                           text: 'en-notes'            },
          // { link: 'https://github.com/Tdahuyou/en-words',   text: 'en-words'            },
          // { ...sidebar__eslint,                             text: 'eslint'              },
          // { ...sidebar__git,                                text: 'git'                 },
          // { ...sidebar__html_css,                           text: 'html-css'            },
          // { ...sidebar__i18n,                               text: 'i18n'                },
          // { ...sidebar__javascript,                         text: 'javascript'          },
          // { ...sidebar__leetcode,                           text: 'leetcode'            },
          // { ...sidebar__markdown,                           text: 'markdown'            },
          // { ...sidebar__miniprogram_wechat,                 text: 'miniprogram_wechat'  },
          // { ...sidebar__nodejs,                             text: 'nodejs'              },
          // { ...sidebar__pc,                                 text: 'pc'                  },
          // { ...sidebar__prettier,                           text: 'prettier'            },
          // { ...sidebar__react,                              text: 'react'               },
          // { ...sidebar__svg,                                text: 'svg'                 },
          // { ...sidebar__typescript,                         text: 'typescript'          },
          // { ...sidebar__vite,                               text: 'vite'                },
          // { ...sidebar__vscode,                             text: 'vscode'              },
          // { ...sidebar__vue,                                text: 'vue'                 },
          // { ...sidebar__webpack,                            text: 'webpack'             },
      ...
      md
        ...
        .use(markdownItContainer, 'swiper', {
          render: (tokens, idx) => {
            ...
            const defaultRenderRulesImage = md.renderer.rules.image || ((tokens, idx, options, env, slf) => slf.renderToken(tokens, idx, options))
            if (tokens[idx].nesting === 1) {
              ...
              md.renderer.rules.image = (tokens, idx, options, env, slf) => `${defaultRenderRulesImage(tokens, idx, options, env, slf).replaceAll('<div class="swiper-slide">', '').replaceAll('</div>', '')}`
