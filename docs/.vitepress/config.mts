...
export default defineConfig({
  ...
  head: [
    ...
    ['link', { rel: 'icon', href: 'https://raw.githubusercontent.com/Tdahuyou/notes/refs/heads/main/docs/public/favicon.ico' }],
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      { ariaLabel: 'Tdahuyou github 主页链接', link: 'https://github.com/Tdahuyou', icon: 'github' },
    ],
